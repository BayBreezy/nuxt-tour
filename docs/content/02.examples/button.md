...
description: Customise the label and icons on every tour button.
navigation.icon: ic:baseline-smart-button
---
...
- `next-button` — <code id="next-btn-code">nextButton</code>
- `skip-button` — <code id="skip-btn-code">skipButton</code>
- `prev-button` — <code id="prev-btn-code">prevButton</code>
- `finish-button` — <code id="finish-btn-code">finishButton</code>
...
<!-- automd:file src="../../app/components/content/examples/ExCustomButton.vue" code name="[CustomButtonExample.vue]" -->

```vue [CustomButtonExample.vue]
<template>
  <div class="not-prose">
...
::prose-callout{variant="tip" title="Icon names"}
Any icon from [Icones](https://icones.js.org/){target="blank"} is supported. Copy the full icon name including the collection prefix (e.g. `heroicons:arrow-right`).
::
