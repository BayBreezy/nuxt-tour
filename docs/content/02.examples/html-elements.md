---
title: "HTML elements"
description: "Pass an HTMLElement directly as the step target instead of a CSS selector."
navigation.icon: heroicons:code-bracket
---
...
<!-- automd:file src="../../app/components/content/examples/ExHtmlElement.vue" code name="[HtmlElementExample.vue]" -->

```vue [HtmlElementExample.vue]
<template>
  <div class="not-prose">
...
::prose-callout{variant="warning" title="Assign in onMounted"}
