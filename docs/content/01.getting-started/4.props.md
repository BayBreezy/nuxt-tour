...
::prose-field-group{variant="all"}
  ...
  :::prose-field{name="transition" type="'fade' | 'slide-up' | 'slide-down' | 'slide-left' | 'slide-right'" defaultValue="fade"}
...
::prose-field-group{variant="all"}
  ...
  :::prose-field{name="transition" type="'fade' | 'slide-up' | 'slide-down' | 'slide-left' | 'slide-right'"}
